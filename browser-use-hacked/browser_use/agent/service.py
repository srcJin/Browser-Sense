...
class Agent(Generic[Context, AgentStructuredOutput]):
	...
	def __init__(
		...
		organized_screenshots: dict | None = None,
		...
		**kwargs,
		...
		self.organized_screenshots = organized_screenshots
	...
	def _set_screenshot_service(self) -> None:
		...
		try:
			...
			self.screenshot_service = ScreenshotService(
				...
				organized_storage=self.organized_screenshots
			)
			if self.organized_screenshots:
				logger.debug(f'📸 Organized screenshot service initialized for: {self.organized_screenshots.get("agent_name", "agent")}')
			else:
